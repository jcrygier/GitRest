...
var detached = window.location.protocol == "file:"
...
if (!detached) {
    jsToLoad.push(window.gitRestResourceBaseUrl + 'main/templates.js');
    jsToLoad.push(window.gitRestStaticBaseUrl + 'js/resources.js');
} else {
    jsToLoad.push('../../../../test/web/js/templates.js');
    jsToLoad.push('../../../../test/web/js/mockResources.js');
}

// Go grab AngularJS and then bootstrap
$script(jsToLoad, function() {
